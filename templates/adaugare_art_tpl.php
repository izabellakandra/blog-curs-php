<form class="form-horizontal tooltip-validation" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <span class="text-muted small-font">Titlul trebuie să fie între 3 și 200 de caractere</span>
        </div>
    </div>                              
    <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <span class="text-muted small-font">Descrierea trebuie să fie între 3 și 10000 de caractere</span>
        </div>
    </div>    
    <div class="form-group">
        <label for="userImage" class="control-label col-md-offset-1 col-md-2">Imagini: </label>
        <div class="col-md-8" >
            <input type="file" class="file" name="caleImg" style="display:inline" id="img_art" data-toggle="popover" data-placement="right" data-content="<?php if(isset($error['img_art'])) echo $error['img_art']; ?>">
            <span class="text-muted small-font">Mărimea imaginei să nu depășească 2MB.<br/>Extensiile acceptate sunt: jpg/jpeg, png, gif </span>
        </div>
    </div>    
    <div class="form-group">
